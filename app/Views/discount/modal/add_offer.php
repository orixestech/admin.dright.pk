...
<div class="modal" id="AddDiscountOfferModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" action="" name="AddDiscountOfferForm" id="AddDiscountOfferForm" class="needs-validation" novalidate=""
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="AddDiscountOfferFormFunction()">Save changes</button>
            </div>
            </form>
...
<script>
    function AddDiscountOfferFormFunction() {
        var formdata = new window.FormData($("form#AddDiscountOfferForm")[0]);
