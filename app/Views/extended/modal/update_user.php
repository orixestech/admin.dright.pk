...
<div class="modal" id="updateNewUserModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" action="" name="EditUserForm" id="EditUserForm" class="needs-validation" novalidate=""
                ...
                <div class="modal-body">
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" id="password" name="password" placeholder="Password" class="form-control" data-validation-engine="validate[minSize[6]]"/>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="EditUserFormFunction()">Save changes</button>
                </div>
            </form>
...
<script>
    function GetBranchData( val ) {
        ...
        if( val == 'superuser' ){
            $("form#EditUserForm div#branchdiv").css( 'display', 'none' );
        }else{
            $("form#EditUserForm div#branchdiv").css(  'display',  '' );
...
<script>
    ...
    function EditUserFormFunction() {
        var formdata = new window.FormData($("form#EditUserForm")[0]);
