...
<div class="modal" id="UpdateSponsereProductModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" action="" name="UpdateSponserProductForm" id="UpdateSponserProductForm" class="needs-validation" novalidate=""
                  enctype="multipart/form-data">
                <input type="hidden" name="UID" id="UID" value="0">
                <input type="hidden" name="SponsorProduct[SponsorID]" id="SponsorID" value="">

                <div class="modal-header">
                    <h5 class="modal-title">Update Sponsor Product</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="UpdateSponserProductFormFunction()">Save changes</button>
                </div>
            </form>
...
<script>
    ...
    function UpdateSponserProductFormFunction() {
        var formdata = new window.FormData($("form#UpdateSponserProductForm")[0]);
