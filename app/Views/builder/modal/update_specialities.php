...
<div class="modal" id="UpdatespecialitiesModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" action="" name="UpdatespecialitiesForm" id="UpdatespecialitiesForm" class="needs-validation" novalidate=""
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="UpdatespecialitiesFormFunction()">Save changes</button>
                </div>
            </form>
