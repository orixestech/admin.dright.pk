...
<div class="modal" id="UpdateSponsereModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" action="" name="UpdateSponserForm" id="UpdateSponserForm" class="needs-validation" novalidate=""
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="UpdateSponserFormFunction()">Save changes</button>
                </div>
            </form>
...
<script>
    ...
    function UpdateSponserFormFunction() {
        var formdata = new window.FormData($("form#UpdateSponserForm")[0]);
