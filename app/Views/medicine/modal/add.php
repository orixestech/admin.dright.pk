...
<div class="modal" id="AddMedicineModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" action="" name="AddMedicineForm" id="AddMedicineForm" class="needs-validation" novalidate=""
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="AddMedicineFormFunction()">Save changes</button>
            </div>
            </form>
...
<script>
    ...
    function AddMedicineFormFunction() {
        var formdata = new window.FormData($("form#AddMedicineForm")[0]);
