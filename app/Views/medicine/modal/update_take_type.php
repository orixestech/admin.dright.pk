...
<div class="modal" id="UpdateTakeTypeMedicineModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" action="" name="UpdateTakeTypeMedicineForm" id="UpdateTakeTypeMedicineForm" class="needs-validation" novalidate=""
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="UpdateTakeTypeMedicineFormFunction()">Save changes</button>
                </div>
            </form>
...
<script>
    ...
    function UpdateTakeTypeMedicineFormFunction() {
        var formdata = new window.FormData($("form#UpdateTakeTypeMedicineForm")[0]);
