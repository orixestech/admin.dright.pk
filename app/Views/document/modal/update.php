...
<div class="modal" id="UpdateDocumentModal" tabindex="-1" role="dialog">
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            <form method="post" action="" name="UpdateDocumentForm" id="UpdateDocumentForm" class="needs-validation" novalidate=""
                ...
                <div class="modal-body">
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="Heading" name="Document[Heading]"
...
<script>
    $(document).ready(function() {
        $('#UpdateDocumentModal #Description').summernote();
    });
    ...
    function UpdateDocumentFormFunction() {
        var formdata = new window.FormData($("form#UpdateDocumentForm")[0]);
