<div class="modal" id="AddDietCategoryModal" tabindex="-1" role="dialog">
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            <form method="post" action="" name="AddDietCategoryForm" id="AddDietCategoryForm" class="needs-validation" novalidate=""
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="AddDietCategoryFormFunction()">Save changes</button>
                </div>
            </form>
...
<script>
    $(document).ready(function() {
        $('#AddDietCategoryModal #Description').summernote();
    });
