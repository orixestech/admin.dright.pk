...
<div class="card">
    <div class="card-body">
        ...
        <span style="float: right;">
            <button type="button" onclick="AddItem('vegetable')" class="btn btn-primary mr-2 mb-2" data-toggle="modal" data-target="#exampleModal">
                Add Item
            </button>
        </span></h4>
    </div>
    ...
    <script>
        ...
        function ItemDetail(id) {
            location.href = "<?=$path?>diet/vegetable-detail/" + id;
        }
